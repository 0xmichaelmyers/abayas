export default function BrandStory() {
  return (
    <section className="relative bg-[#0d0d0d] py-[120px] px-[80px] max-[900px]:px-6 max-[900px]:py-[80px] overflow-hidden">
      ...
      />
      <div className="relative z-[1] flex items-center gap-[80px] max-w-[1400px] mx-auto max-[900px]:flex-col max-[900px]:gap-[40px]">
        ...
        <div className="flex-1 max-w-[520px] max-[900px]:max-w-none">
          ...
          <p className="text-[13px] leading-[1.85] text-[rgba(237,237,237,0.55)] mb-[48px] max-w-[480px]">
        ...
        {/* Right — Image with gradient line below */}
        <div className="flex-[1.2] flex flex-col gap-[16px] max-[900px]:w-full">
          ...
          {/* Bottom fading line — transparent fades to gold, aligned right */}
